...
const UI_TRANSLATIONS: Record<string, Record<Lang, string>> = {
  ...
  'matching.subtitle': { en: 'Run, upload, inspect, and export product matches', de: 'Produktabgleiche ausführen, hochladen, prüfen und exportieren' },
  ...
  'matching.fuzzy_threshold': { en: 'Fuzzy threshold', de: 'Fuzzy-Schwellenwert' },
  'matching.llm_fallback': { en: 'LLM fallback', de: 'LLM-Fallback' },
  'matching.run_btn': { en: 'Run Matching', de: 'Matching starten' },
  'matching.running': { en: 'Running...', de: 'Läuft...' },
  'matching.failed': { en: 'Matching failed. Is the matcher service running?', de: 'Matching fehlgeschlagen. Läuft der Matching-Dienst?' },
  'matching.source_products': { en: 'Source Products', de: 'Quellprodukte' },
  'matching.total_matches': { en: 'Total Matches', de: 'Treffer gesamt' },
  'matching.products_matched': { en: 'Products Matched', de: 'Zugeordnete Produkte' },
  ...
  'matching.ready_desc': { en: 'Select a category, configure your parameters, and hit Run Matching to start the pipeline.', de: 'Wählen Sie eine Kategorie, konfigurieren Sie die Parameter und klicken Sie auf Matching starten.' },
  'matching.upload_title': { en: 'Upload Source & Target JSON', de: 'Quell- & Ziel-JSON hochladen' },
  'matching.source_json': { en: 'Source products JSON', de: 'Quellprodukte JSON' },
  'matching.target_json': { en: 'Target products JSON', de: 'Zielprodukte JSON' },
  'matching.category_name': { en: 'Category name', de: 'Kategoriename' },
  'matching.upload_btn': { en: 'Upload & Run Pipeline', de: 'Hochladen & Pipeline starten' },
  'matching.uploading': { en: 'Uploading...', de: 'Wird hochgeladen...' },
  'matching.upload_failed': { en: 'Upload failed. Is the matcher service running?', de: 'Upload fehlgeschlagen. Läuft der Matching-Dienst?' },
  'matching.upload_result': { en: '{matches} matches found for {sources} sources ({covered} covered)', de: '{matches} Treffer für {sources} Quellen gefunden ({covered} abgedeckt)' },
  'matching.submission_json': { en: 'Submission JSON', de: 'Einreichungs-JSON' },
  'matching.download_json': { en: 'Download JSON', de: 'JSON herunterladen' },
  'matching.loading_submission': { en: 'Loading submission...', de: 'Einreichung wird geladen...' },
  ...
  'matching.fuzzy_token_sort': { en: 'Fuzzy (token sort)', de: 'Fuzzy (Token-Sortierung)' },
  'matching.fuzzy_token_set': { en: 'Fuzzy (token set)', de: 'Fuzzy (Token-Menge)' },
  'matching.model_prefix': { en: 'Model prefix chars', de: 'Modell-Präfix-Zeichen' },
  ...
  'matching.analyzing': { en: 'Analyzing match signals...', de: 'Match-Signale werden analysiert...' },
  'matching.export_failed': { en: 'Failed to export submission.', de: 'Export der Einreichung fehlgeschlagen.' },
