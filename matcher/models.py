...
BRAND_MAP = {
    ...
    "aeg": "AEG",
    "beko": "BEKO",
    "beko germany gmbh": "BEKO",
    "beko austria ag": "BEKO",
    "beko europe management s.r.l": "BEKO",
    "beko europe management s.r.l.": "BEKO",
    "beko europe austria gmbh": "BEKO",
    "gorenje": "Gorenje",
    "hisense gorenje germany gmbh": "Gorenje",
    "exquisit": "Exquisit",
    "hoover": "Hoover",
    "candy hoover group s.r.l.": "Hoover",
    "candy hoover group srl": "Hoover",
    "caso": "CASO",
    "caso gmbh": "CASO",
    "grafner": "Grafner",
    "steba": "STEBA",
    ...
    "delta pronatura gmbh": "Dr. Beckmann",
    "bauknecht": "Bauknecht",
    "bosch": "Bosch",
    "robert bosch hausgeräte gmbh": "Bosch",
    "bsh hausgeräte gmbh": "Bosch",
    "neff": "Neff",
    "constructa-neff vertriebs-gmbh": "Neff",
    "miele": "Miele",
    "miele gesellschaft m.b.h.": "Miele",
    "whirlpool": "Whirlpool",
    "privileg": "Privileg",
    "candy": "Candy",
    "indesit": "Indesit",
    ...
    "electrolux austria gmbh": "Electrolux",
    "electrolux hausgeräte gmbh": "Electrolux",
    "amica": "Amica",
    "pkm": "PKM",
