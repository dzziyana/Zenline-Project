...
class ExpertScraper(BaseScraper):
    ...
    async def _parse_search_results(self, url: str) -> list[TargetProduct]:
        ...
        try:
            ...
            for item in soup.select(".product-item, .productListItem, [data-product]"):
